...
const description =
  "My final work as a graduate student. This paper explores the vulnerability of machine learning's most contemporary privacy-aware DNN model design (i.e., split learning). In this work, we demonstrate an 'honest-but-curious' adversary's ability to infer private properties of clients' data without model poisoning or manipulation. In addition, we detail and analyze two solutions to this vulnerability.";
